<?php 
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'add_news') {
		...
		$_SESSION['message'] .= '<p>Uspiješno dodana nova novost!</p>';
	...
	#Add news 
		...
		<form action="" id="news_form" name="news_form" method="POST" enctype="multipart/form-data">
			...
			<label for="archive">Deaktiviraj :</label><br />
		...
		<div id="news">
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					print '
					<tr>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;id=' .$row['id']. '"><img src="image/user.png" alt="user"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img src="image/edit.png" alt="uredi"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="image/delete.png" alt="obriši"></a></td>
						<td>' . $row['title'] . '</td>
						<td>';
						...
						<td>';
							if ($row['archive'] == 'Y') { print '<img src="image/inactive.png" alt="" title="" />'; }
                            else if ($row['archive'] == 'N') { print '<img src="image/active.png" alt="" title="" />'; }
						print '
						</td>
					</tr>';
				}
			...
			<a href="index.php?menu=' . $menu . '&amp;action=' . $action . '&amp;add=true" class="AddLink"><h3>Dodaj *NOVU* novost!!</h3></a>
		</div>
		<br></br>
		<br></br>
		<br></br>';
